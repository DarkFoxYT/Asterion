...
import sys
source=sys.argv[1] if len(sys.argv)>1 else 'C:/Users/darkf/Downloads/portal.bp'
output=sys.argv[2] if len(sys.argv)>2 else 'src/main/resources/data/asterion/structure/portal.nbt'
...
for section in d['BlockRegion']:
 ...
 for i in range(4096):
  ...
  if str(state['Name'])=='minecraft:cyan_wool':markers.append(pos)
