...
import sys
source=sys.argv[1] if len(sys.argv)>1 else 'C:/Users/darkf/Downloads/tree_fixed.bp'
output=sys.argv[2] if len(sys.argv)>2 else 'src/main/resources/data/asterion/structure/tree_beetle.nbt'
