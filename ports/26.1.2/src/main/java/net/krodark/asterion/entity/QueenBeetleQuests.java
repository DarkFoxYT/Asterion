...
public final class QueenBeetleQuests {
    ...
    public static final List<Quest> ALL = List.of(
            new Quest("petals", Asterion.TAINTED_PETALS, 8, AncientContent.ANCIENT_BONE, 2),
            ...
            new Quest("compost_keepers", Items.ROTTEN_FLESH, 16, AncientContent.ANCIENT_BONE, 3),
            ...
            new Quest("gilded_shells", Items.GOLD_INGOT, 4, Asterion.BONESTEEL_INGOT, 1),
