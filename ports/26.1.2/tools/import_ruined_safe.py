...
import sys
source=sys.argv[1] if len(sys.argv)>1 else 'C:/Users/darkf/Downloads/ruined_safehouse_1.bp'
output=sys.argv[2] if len(sys.argv)>2 else 'src/main/resources/data/asterion/structure/ruined_safe_room_1.nbt'
...
for section in d['BlockRegion']:
 ...
 for i in range(4096):
  ...
  if str(state['Name'])=='minecraft:red_wool':markers.append(pos)
