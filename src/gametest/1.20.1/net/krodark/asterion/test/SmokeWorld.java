...
final class SmokeWorld {
 static void create(net.minecraft.client.Minecraft client) {
  ...
  client.createWorldOpenFlows().createFreshLevel("asterion-smoke-"+System.currentTimeMillis(),settings,new net.minecraft.world.level.levelgen.WorldOptions(321L,false,false),net.minecraft.world.level.levelgen.presets.WorldPresets::createNormalWorldDimensions);
 }
}
