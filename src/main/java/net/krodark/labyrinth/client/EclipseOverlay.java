...
public final class EclipseOverlay {
    private static final Component TITLE = Component.translatable("event.labyrinth.eclipse.title");

    private EclipseOverlay() { }

    public static void register() {
        HudElementRegistry.addLast(Labyrinth.id("eclipse_overlay"), EclipseOverlay::render);
    }
