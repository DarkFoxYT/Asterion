...
public final class EssentialLaunchSmokeTest {
    ...
    public static void install() {
        ...
        net.fabricmc.fabric.api.client.event.lifecycle.v1.ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            if (++ticks[0] == 1 && startup)
                net.krodark.asterion.Asterion.LOGGER.info("Startup: title screen ready at {} ms JVM uptime",
            ...
            if (startup) {
                ...
                net.krodark.asterion.Asterion.LOGGER.info("PASS: startup stability, 600 client ticks, compiler tier {}, runtime mods loaded: {}",
                        vm.getVMOption("TieredStopAtLevel").getValue(), loader.getAllMods().size());
