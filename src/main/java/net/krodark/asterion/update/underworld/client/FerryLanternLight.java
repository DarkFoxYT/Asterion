    ...
    public static void initialize() {
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            for (CharonsFerryEntity ferry : client.level.getEntitiesOfClass(CharonsFerryEntity.class,
                ...
                var position = ferry.position().add(net.krodark.asterion.update.underworld.world.FerryHull.world(
                        new net.minecraft.world.phys.Vec3(0, net.krodark.asterion.update.underworld.world.FerryHull.DECK + 1.15, -2.75),
