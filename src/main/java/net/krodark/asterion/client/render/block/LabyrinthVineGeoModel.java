...
public final class LabyrinthVineGeoModel extends GeoModel<LabyrinthVineBlockEntity> {
    ...
    private static final Identifier UPRIGHT_MODEL = Asterion.id("block/labyrinth_vine_up");
    ...
    @Override public Identifier getModelResource(GeoRenderState state) {
        return state.getOrDefaultGeckolibData(FACING, Direction.DOWN) == Direction.UP ? UPRIGHT_MODEL : MODEL;
    }
