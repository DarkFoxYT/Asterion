...
public final class ScarletCentipedeGeoModel extends GeoModel<ScarletCentipedeEntity> {
    private static final Identifier MODEL = Asterion.id("entity/scarlet_centipede");
    private static final Identifier TEXTURE = Identifier.withDefaultNamespace("textures/block/red_concrete.png");
    private static final Identifier ANIMATIONS = Asterion.id("entity/scarlet_centipede");
