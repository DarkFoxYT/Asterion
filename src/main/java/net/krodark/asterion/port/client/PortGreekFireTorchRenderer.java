...
//?} else {
/*super.preRender(poses, torch, model, buffers, buffer, rerender, partialTick, light, overlay, ((color >> 16) & 255) / 255F, ((color >> 8) & 255) / 255F, (color & 255) / 255F, ((color >>> 24) & 255) / 255F);*/
//?}
