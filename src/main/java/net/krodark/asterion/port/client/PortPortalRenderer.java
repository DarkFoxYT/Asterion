...
public final class PortPortalRenderer {
    private static final ResourceLocation CORE_ID = Asterion.id("gateway/portal_core");
    private static final ResourceLocation HALO_ID = Asterion.id("gateway/portal_halo");
    private static final ResourceLocation SHADER = Asterion.id("portal/asterion_portal");
    private static final ResourceLocation PORTAL_IMAGE = Asterion.id("textures/portal/asterion_portal_square.png");
    private static final ResourceLocation OVERWORLD_IMAGE = Asterion.id("textures/portal/overworld_portal_square.png");
    ...
    public static void tick(Minecraft client) {
        if (portalWorld != client.level) close();
        ...
        int particleInterval = switch (Math.min(AsterionConfig.INSTANCE.ambientParticleQuality,
                PortPerformanceGovernor.quality())) {
            case 0 -> 9;
            case 1 -> 6;
            default -> 3;
        };
    ...
    private static void registerLayer(ResourceLocation id, boolean halo) {
