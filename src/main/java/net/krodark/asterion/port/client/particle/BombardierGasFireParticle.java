...
public final class BombardierGasFireParticle extends AnimatedEmissiveParticle {
    ...
    static void applyFireColor(TextureSheetParticle particle, float progress) {
        applyFireColor(particle, progress, false);
    }
    static void applyFireColor(TextureSheetParticle particle, float progress, boolean greekFire) {
