...
import net.krodark.asterion.port.client.ragdoll.DazeOverlay;
...
public final class RagdollClientController {
    ...
    public static void tick(Minecraft client) {
        ...
        boolean fallingIntoVoid = client.player.getY() <= client.level.getMinBuildHeight() + 12.0D;
        if (fallingIntoVoid) {
        ...
        boolean input = client.screen == null && client.isWindowActive();
        ...
        if (!tumbling || DazeOverlay.isActive() || net.krodark.asterion.entity.MinotaurEntity.isHeld(client.player)) {
            ...
            if (input && recovery && (mash ? !recoveryWasDown : client.player.tickCount % 3 == 0)) {
        ...
        if (input && !DazeOverlay.isActive()) engine.applyPlayerTumbleInput(client,
