...
public final class PortCursedBrazierCinematic {
    ...
    private PortCursedBrazierCinematic() {
    }

    public static void register() {
        net.fabricmc.fabric.api.client.rendering.v1.HudRenderCallback.EVENT.register( (graphics, tracker) -> {
