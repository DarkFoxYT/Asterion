...
//?} else {
/*public void renderTyped(BarrelDoorBlockEntity door, float partialTick, PoseStack poses,
                           MultiBufferSource buffers, int light, int overlay) {*/
//?}
...
//?} else {
/*super.renderTyped(door, partialTick, poses, buffers, light, overlay);*/
//?}
...
public void render(MinotaurDoorBlockEntity door, float partialTick, PoseStack poses,
                           MultiBufferSource buffers, int light, int overlay) {
//?} else {
/*public void renderTyped(MinotaurDoorBlockEntity door, float partialTick, PoseStack poses,
                           MultiBufferSource buffers, int light, int overlay) {*/
//?}
...
public void render(CursedBrazierDoorBlockEntity door, float partialTick, PoseStack poses,
                           MultiBufferSource buffers, int light, int overlay) {
//?} else {
/*public void renderTyped(CursedBrazierDoorBlockEntity door, float partialTick, PoseStack poses,
                           MultiBufferSource buffers, int light, int overlay) {*/
//?}
