...
public final class DazeOverlay {
    ...
    public static void register() {
        net.fabricmc.fabric.api.client.rendering.v1.HudRenderCallback.EVENT.register((graphics, delta) -> render(graphics));
    }
    ...
    public static void tick(Minecraft client) {
        ...
        boolean down = client.screen == null && client.isWindowActive() && GLFW.glfwGetKey(client.getWindow().getWindow(),
    ...
    private static void render(GuiGraphics graphics) {
        ...
        graphics.drawCenteredString(client.font, Component.literal(instruction),
