...
public final class QueenBeetleQuests {
    ...
    public static final List<Quest> ALL = List.of(
            ...
            new Quest("royal_feast", Asterion.POPPED_ANCIENT_VINES, 12, Asterion.TARNISHED_GOLD_INGOT, 2),
            ...
            new Quest("bronze_promise", Asterion.CELESTIAL_BRONZE_INGOT, 2, Asterion.FORGED_INGOT, 2),
