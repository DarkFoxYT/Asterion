...
public final class QueenBeetleQuests {
    ...
    public static final List<Quest> ALL = List.of(
            new Quest("petals", Asterion.TAINTED_PETALS, 8, Asterion.SHALE_TARNISHED_GOLD_ORE, 2),
            ...
            new Quest("royal_feast", Asterion.POPPED_ANCIENT_VINES, 12, Asterion.SHALE_TARNISHED_GOLD_ORE, 2),
            new Quest("fallen_timber", Asterion.DEAD_WOOD, 8, Items.RAW_IRON, 3),
            ...
            new Quest("compost_keepers", Items.ROTTEN_FLESH, 16, Asterion.SHALE_TARNISHED_GOLD_ORE, 3),
            new Quest("fungal_gardens", Items.BROWN_MUSHROOM, 8, Items.GOLDEN_CARROT, 4),
            new Quest("light_the_paths", Items.TORCH, 16, Items.RAW_IRON, 4),
            ...
            new Quest("gilded_shells", Items.GOLD_INGOT, 4, Asterion.SHALE_CELESTIAL_GOLD_ORE, 1),
            ...
            new Quest("green_watchfires", Items.LANTERN, 6, Asterion.DEADWOOD_STICK, 8),
            new Quest("forgotten_gold", Asterion.TARNISHED_GOLD_INGOT, 3, Items.EMERALD, 8),
            new Quest("bronze_promise", Asterion.CELESTIAL_BRONZE_INGOT, 2, Asterion.SHALE_TARNISHED_GOLD_ORE, 2),
            new Quest("queens_covenant", Asterion.CELESTIAL_GOLD_INGOT, 1, Asterion.SHALE_CELESTIAL_GOLD_ORE, 1)
    );
