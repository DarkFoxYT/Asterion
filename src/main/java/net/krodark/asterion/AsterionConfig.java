...
public final class AsterionConfig {
    ...
    public int decorationRenderDistance = 64;
    public boolean blockLightUpdates = true;
    public int ambientParticleQuality = 2;
    public boolean potatoParticleCulling = false;
    public int maxEmissiveParticles = 4096;
    public int emissiveParticleDistance = 128;
    ...
    public void sanitize() {
        ...
        performanceTargetFps = Math.max(30, Math.min(360, performanceTargetFps));
